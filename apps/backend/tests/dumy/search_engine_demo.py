...
from apps.backend.bot.workflow.web.content_extractor import WebContentService
from apps.backend.bot.workflow.web.providers.duckduckgo_provider import DuckDuckGoSearchProvider
